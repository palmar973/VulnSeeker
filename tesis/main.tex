...
falsos positivos observados durante el escenario experimental definido, lo cual se atribuye al uso de payloads específicos y al
...
\begin{enumerate}
    ...
    críticas (SQLi, XSS, Command Injection, LFI) sin falsos positivos observados
    en los módulos de inyección durante el escenario experimental definido. Estos resultados validan la tesis central de
