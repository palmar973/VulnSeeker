...
\begin{table}[H]
    ...
    \begin{tabular}{l r}
        ...
        \midrule
        Total de hallazgos        & 398 \\
        Críticos (CRITICAL)       & 3 (0,8\%) \\
        Altos (HIGH)              & 60 (15,1\%) \\
        Medios (MEDIUM)           & 75 (18,8\%) \\
        Bajos (LOW)               & 259 (65,1\%) \\
...
\begin{table}[H]
    ...
    \begin{tabular}{c l c c}
        ...
        3 & Server Version Disclosure        & 55 & MEDIUM \\
        4 & Missing X-Frame-Options          & 55 & MEDIUM \\
        5 & Missing Content-Security-Policy   & 55 & MEDIUM \\
        \bottomrule
    \end{tabular}
\end{table}
...
\begin{table}[H]
    ...
    \begin{tabular}{p{4cm} p{4.2cm} c c}
        ...
        SQL Injection      & 2 (\texttt{/sqli/}, \texttt{/brute/}) & 0 & 100\% \\
...
vulnerabilidad en su ubicación esperada dentro de DVWA ---SQL Injection en los
formularios de \texttt{/sqli/} y \texttt{/brute/}, XSS reflejado en
\texttt{/xss\_r/}, ejecución de comandos en \texttt{/exec/}, inclusión de
...
patrones de error y a la validación contra baseline descrita en la sección
anterior. Los módulos de configuración reportaron un hallazgo por endpoint
